...
build_postgres:
	...
	docker buildx build . -f ./postgres/13/Dockerfile --tag ${POSTGRES_IMAGE_ID}:13 --tag ${POSTGRES_IMAGE_ID}:latest --platform linux/amd64,linux/arm64
...
push_postgres:
	...
	docker buildx build . -f ./postgres/13/Dockerfile --tag ${POSTGRES_IMAGE_ID}:13 --tag ${POSTGRES_IMAGE_ID}:latest --platform linux/amd64,linux/arm64 --push
...
build_postgis:
	...
	docker buildx build . -f ./postgis/13/Dockerfile --tag ${POSTGIS_IMAGE_ID}:13-3.1 --tag ${POSTGIS_IMAGE_ID}:13 --tag ${POSTGIS_IMAGE_ID}:latest --platform linux/amd64,linux/arm64
...
push_postgis:
	...
	docker buildx build . -f ./postgis/13/Dockerfile --tag ${POSTGIS_IMAGE_ID}:13-3.1 --tag ${POSTGIS_IMAGE_ID}:13 --tag ${POSTGIS_IMAGE_ID}:latest --platform linux/amd64,linux/arm64 --push
